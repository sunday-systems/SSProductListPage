...
class Version201708310000 extends AbstractMigration
{
    ...
    {
        $table = $schema->createTable("plg_ss_product_list_layout");
        ...
        $table->addForeignKeyConstraint('plg_ss_product_list_layout', array('page_id'), array('page_id'));
    ...
    {
        $schema->dropTable('plg_ss_product_list_layout');
        $schema->dropTable('plg_ss_product_list_block_position');
    }
}